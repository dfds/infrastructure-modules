...
inputs = {
  ...
  eks_managed_nodegroups = {
    "general" = {
      ...
      # currentImageName=amazon-eks-node-al2023-x86_64-standard-1.33-v20251103
      ami_id             = "ami-035c02db192d3448c"
