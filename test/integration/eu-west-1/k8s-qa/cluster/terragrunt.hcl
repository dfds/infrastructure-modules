...
inputs = {
  ...
  eks_addon_awsefscsidriver_version_override = "v2.1.15-eksbuild.1"
  ...
  eks_managed_nodegroups = {
    "general" = {
      ...
      # currentImageName=amazon-eks-node-al2023-x86_64-standard-1.33-v20251108
      ami_id             = "ami-0d32d6f957607047b"
