...
inputs = {
  ...
  eks_addon_vpccni_version_override = "v1.20.5-eksbuild.1"
  ...
  eks_addon_kubeproxy_version_override = "v1.33.5-eksbuild.2"
  ...
  eks_addon_awsebscsidriver_version_override = "v1.53.0-eksbuild.1"
