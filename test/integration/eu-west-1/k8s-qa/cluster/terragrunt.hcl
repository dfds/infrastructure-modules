...
inputs = {
  ...
  eks_addon_awsefscsidriver_version_override = "v2.3.0-eksbuild.2"
  ...
  eks_managed_nodegroups = {
    "general" = {
      ...
      # currentImageName=amazon-eks-node-al2023-x86_64-standard-1.33-v20260209
      ami_id             = "ami-06f3dacf68f096d6d"
