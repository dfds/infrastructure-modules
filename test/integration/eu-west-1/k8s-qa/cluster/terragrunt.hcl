...
inputs = {
  ...
  eks_addon_awsebscsidriver_version_override = "v1.48.0-eksbuild.2"
  ...
  eks_managed_nodegroups = {
    "general" = {
      ...
      # currentImageName=amazon-eks-node-al2023-x86_64-standard-1.33-v20250915
      ami_id             = "ami-06cbaae8cf8057acc"
