...
data "aws_eks_addon_version" "aws_s3_csi_driver" {
...
locals {
  ...
  awss3csidriver_version  = var.awss3csidriver_version_override == "" ? data.aws_eks_addon_version.aws_s3_csi_driver.version : var.awss3csidriver_version_override
}
