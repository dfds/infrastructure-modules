...
output "alb_target_group_arn_suffix_blue" {
  value = var.deploy_blue_variant ? aws_lb_target_group.traefik_blue_variant[0].arn_suffix : ""
}

output "alb_target_group_arn_suffix_green" {
  value = var.deploy_green_variant ? aws_lb_target_group.traefik_green_variant[0].arn_suffix : ""
}
