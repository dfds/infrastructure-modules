...
output "traefik_blue_variant_dashboard_url" {
  value       = "https://traefik-blue-variant.${var.eks_cluster_name}.${var.workload_dns_zone_name}/dashboard/"
  description = "The URL for accessing the Traefik Blue Variant dashboard)."
}

output "traefik_green_variant_dashboard_url" {
  value       = "https://traefik-green-variant.${var.eks_cluster_name}.${var.workload_dns_zone_name}/dashboard/"
